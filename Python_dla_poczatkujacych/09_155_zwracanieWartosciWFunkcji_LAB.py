...
\    -   -    /
 ...
 | \_ / `;=/ " \=;` \ _/ |
  \/ `\__|`\___/`|__/`  \/
    ...
    return True
#sprawdzenie wartosci logicznych, jesli true to parameter was correct jesli false to icorrect
if PrintAnimal():
...
delta = DaysToEndOfYear(2020,12,20)
print('There are ',delta,'days till end of year')
